...
export const es = {
  ...
  labelBotones: 'Botones (opcional)',
  agregarRapida: 'Respuesta rápida',
  agregarEnlace: 'Enlace',
  phBotonRapida: 'Confirmar',
  phBotonEnlace: 'Ver mi cita',
  phUrl: 'https://tunegocio.mx/citas',
  quitarBoton: 'Quitar botón',
  ayudaBotones: 'La respuesta rápida contesta en el chat; el enlace abre una página. Máximo 2 enlaces y el destino debe ser fijo (sin variables).',
  enviando: 'Enviando...',
...
export const en = {
  ...
  labelBotones: 'Buttons (optional)',
  agregarRapida: 'Quick reply',
  agregarEnlace: 'Link',
  phBotonRapida: 'Confirm',
  phBotonEnlace: 'View my appointment',
  phUrl: 'https://yourbusiness.com/appointments',
  quitarBoton: 'Remove button',
  ayudaBotones: 'A quick reply answers in the chat; a link opens a page. Up to 2 links, and the destination must be fixed (no variables).',
  enviando: 'Submitting...',
